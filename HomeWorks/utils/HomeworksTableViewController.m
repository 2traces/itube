...
- (void)viewDidLoad
{
    ...
    if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0")) {
        ...
        tableButtomTopPressedImage = [[UIImage imageNamed:@"table_button_mid_pressed"] stretchableImageWithLeftCapWidth:10 topCapHeight:10];
        ...
        tableButtonDownPressedImage = [[UIImage imageNamed:@"table_button_mid_pressed"] stretchableImageWithLeftCapWidth:10 topCapHeight:10];
        tableButtonSingleImage = [[UIImage imageNamed:@"table_button_mid"] stretchableImageWithLeftCapWidth:10 topCapHeight:10];
        tableButtonSinglePressedImage = [[UIImage imageNamed:@"table_button_mid_pressed"] stretchableImageWithLeftCapWidth:10 topCapHeight:10];
    }
    else {
