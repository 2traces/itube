...
//    if ([self.subtitleLabel canBecomeFirstResponder]) {
//        [self.subtitleLabel becomeFirstResponder];
//    }
//	[self.subtitleLabel touchesBegan:touches withEvent:event];
...
//    [self.subtitleLabel touchesMoved:touches withEvent:event];
//
//	if(!self.copyActive) {
...
//    [self.subtitleLabel touchesCancelled:touches withEvent:event];
//
//	if(self.copyActive){
...
//{
//	[copyPasteTimer invalidate];
//    [self.subtitleLabel touchesEnded:touches withEvent:event];
//
//	if(!self.copyActive){
